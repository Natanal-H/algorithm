# 프로그래머스 문제 풀이 - [2021 KAKAO BLIND RECRUITMENT] 신규 아이디 추천 (72410)

## 문제 정보
# **문제 이름**: [2021 KAKAO BLIND RECRUITMENT] 신규 아이디 추천
# **문제 번호**: 72410
# **문제 레벨**: 1
# **링크**: [링크](https://programmers.co.kr/learn/courses/30/lessons/72410)
# **풀이 날짜** : 2024-11-13
...
# 규칙에 맞는 새로운 아이디를 추천해 주려고 합니다. 신규 유저가 입력한 아이디가 new_id 라고 한다면,
#
...
def solution(new_id):
    new_id = new_id.lower()
    new_id = re.sub(r'[^a-z0-9-_.]', '', new_id); print(new_id)
