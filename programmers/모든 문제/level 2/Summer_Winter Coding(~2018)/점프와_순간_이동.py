# 프로그래머스 문제 풀이 - [Summer/Winter Coding(~2018)] 점프와 순간 이동 (12980)

## 문제 정보
# **문제 이름**: [Summer/Winter Coding(~2018)] 점프와 순간 이동
# **문제 번호**: 12980
# **문제 레벨**: 2
# **링크**: [링크](https://programmers.co.kr/learn/courses/30/lessons/12980)
# **풀이 날짜** : 2024-11-22
