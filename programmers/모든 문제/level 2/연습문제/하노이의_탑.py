# 프로그래머스 문제 풀이 - 하노이의 탑 (12946)

## 문제 정보
# **문제 이름**: 하노이의 탑
# **문제 번호**: 12946
# **문제 레벨**: 2
# **링크**: [링크](https://programmers.co.kr/learn/courses/30/lessons/12946)
# **풀이 날짜** : 2024-11-21
...
def hanoi(n, start, other, end):
    ...
    return hanoi(n-1,start,end,other) + [[start, end]] + hanoi(n-1,other,start,end)
