# 프로그래머스 문제 풀이 - 혼자 놀기의 달인 (131130)

## 문제 정보
# **문제 이름**: 혼자 놀기의 달인
# **문제 번호**: 131130
# **문제 레벨**: 2
# **링크**: [링크](https://programmers.co.kr/learn/courses/30/lessons/131130)
# **풀이 날짜** : 2024-12-02
...
# 다음으로 확인한 카드에 적힌 번호에 해당하는 상자를 열어 안에 담긴 카드에 적힌 숫자를 확인합니다. 마찬가지로 숫자에 해당하는 번호를 가진 상자를 계속해서 열어가며, 열어야 하는 상자가 이미 열려있을 때까지 반복합니다.
#
